# This entire module is copied from https://github.com/dodo-saba/fit2gpx
# I modified all column names because my Strava bulk download is in spanish
# so this module -as is- in the above repo did not work.
...
class StravaConverter(Converter):
    ...
    def add_metadata_to_gpx(self):
        ...
        for gpx_path in gpx_files:
            ...
            # -- identify corresponding activity in md
            md = df_acts.loc[df_acts['Nombre de archivo'].str.contains(gpx_path)].iloc[0, :].to_dict()
            # act_id = md['Activity ID'] 
            # act_name = md['Activity Name']
            # act_desc = md['Activity Description']
